 ...
 * that is e.g. generated by the @ref InstantEntry, is processed by 
 ...
 * that is e.g. generated by the @ref DeterministicTaskCompletion, is processed by 
 * @ref Engine::process(const TaskCompletionEvent& event).
 * 
 * A token at a @ref BPMN::MessageCatchEvent remains in `BUSY` state until a 
 * @ref MessageDeliveryEvent, that is e.g. generated by the @ref FirstMatchingMessageDelivery,
 ...
 * state is only revealed upon completion of the task. When using the @ref DeterministicTaskCompletion,
...
public:
  ...
  State state;
  Values status;
  Globals* data; ///< Pointer to the data of the owner or owned state machine subprocesses)
