...
SCENARIO( "Empty executable process", "[cpmodel][process]" ) {
...
SCENARIO( "Trivial executable process", "[cpmodel][process]" ) {
...
SCENARIO( "Simple executable process", "[cpmodel][process]" ) {
