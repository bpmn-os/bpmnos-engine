...
//      Execution::Recorder recorder;
      ...
      THEN( "The dump of each entry of the recorder log is correct" ) {
        ...
        // advance to busy process and event subprocess
...
//      Execution::Recorder recorder(std::cerr);
      ...
      THEN( "The dump of each entry of the recorder log is correct" ) {
        ...
        // event subprocess
        REQUIRE( recorder.log[++i].dump() == "{\"processId\":\"Process_1\",\"instanceId\":\"Instance_1\",\"nodeId\":\"StartEvent_2\",\"state\":\"ENTERED\",\"status\":{\"timestamp\":1.0,\"instance\":\"Instance_1\"}}" );
        REQUIRE( recorder.log[++i].dump() == "{\"processId\":\"Process_1\",\"instanceId\":\"Instance_1\",\"nodeId\":\"StartEvent_2\",\"state\":\"DONE\",\"status\":{\"timestamp\":1.0,\"instance\":\"Instance_1\"}}" );
        // process
