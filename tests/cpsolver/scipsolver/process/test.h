SCENARIO( "Empty executable process - SCIP solver", "[scipsolver][process]" ) {
...
SCENARIO( "Trivial executable process - SCIP solver", "[scipsolver][process]" ) {
...
SCENARIO( "Simple executable process - SCIP solver", "[scipsolver][process]" ) {
