SCENARIO( "Sequential adhoc subprocess - SCIP solver", "[cpsolver][adhocsubprocess]" ) {
...
SCENARIO( "Sequential adhoc subprocesses with common performer - SCIP solver", "[cpsolver][adhocsubprocess]" ) {
