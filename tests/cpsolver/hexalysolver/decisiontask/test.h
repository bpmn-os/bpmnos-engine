SCENARIO( "Decision task with enumeration - Hexaly solver", "[hexalysolver][decisiontask]" ) {
...
SCENARIO( "Decision task with bounds - Hexaly solver", "[hexalysolver][decisiontask]" ) {
