SCENARIO( "CPController with sequential adhoc subprocess", "[cpcontroller][adhocsubprocess]" ) {
...
SCENARIO( "CPController with sequential adhoc subprocesses with common performer", "[cpcontroller][adhocsubprocess]" ) {
