SCENARIO( "CPController with decision task with enumeration", "[cpcontroller][decisiontask]" ) {
...
SCENARIO( "CPController with decision task with bounds", "[cpcontroller][decisiontask]" ) {
