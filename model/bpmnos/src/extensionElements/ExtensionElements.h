...
//  enum Index { Instance, Timestamp }; ///< Indices for instance and timestamp attribute.
  ...
  DataUpdate dataUpdateOnEntry; ///< Vector containing data attributes that are modified upon entry.
  DataUpdate dataUpdateOnCompletion; ///< Vector containing data attributes that are modified upon completion.
